...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:dropdown__listbox": {
    ...
    "group-data-[overscroll]:border": false,
  ...
  "family:dropdown__listitem": {
    ...
    "data-[is-active]:before:ring-1": false,
  ...
  "family:dropdown__tagWrapper": {
    ...
    "mb-1": true,
    "outline-none": true,
    "data-[active-selection=true]:ring-2": false,
  ...
  "autocomplete__selectionWrapper": {
    "bg-neutral-100": true,
    "rounded": true,
    "group-data-[multiple]:border": false,
  ...
  "colorpicker__panel": {
    ...
    "group-data-[inline]:w-full": true,
    "group-data-[inline]:shadow": false,
  ...
  "colorpicker__swatch": {
    ...
    "data-[active=true]:after:ring-1": false,
    ...
    "[&>canvas:focus-visible]:ring-2": false,
  ...
  "transferlist__transferlist": {
    ...
    "overflow-hidden": true,
    "select-none": true,
    "[&:has(:focus-visible)]:ring-1": false,
  ...
  "multi-step__wrapper": {
    "group/wrapper": true,
    "data-[tab-style=\"tab\"]:shadow": false,
  ...
  "multi-step__tabs": {
    ...
    "group-data-[tab-style=\"tab\"]/wrapper:border": false,
  ...
  "multi-step__steps": {
    ...
    "group-data-[tab-style=\"progress\"]/wrapper:shadow": false,
